 ...
 */
public class Online_Adapter extends RecyclerView.Adapter<Online_Adapter.ViewHolder> {
    private int[] imglist, titlelist, contentlist, tag_line,poster,back_color;
    int pos_of_item;
    Context context;
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        public ImageView imageView,imageView_background;
    ...
    public Online_Adapter(int[] contacts, int[] title, int[] tagline, int[] content,int[] post,int[] back) {
        imglist = contacts;
        titlelist = title;
        tag_line = tagline;
        contentlist = content;
    ...
    @Override
    public void onBindViewHolder(final Online_Adapter.ViewHolder viewHolder, final int position) {
        // Get the data model based on position
        pos_of_item = position;
        ...
        final int[] back_col = context.getResources().getIntArray(R.array.online);
...
//                imageView.setImageBitmap(blurred);
    ...
    @Override
    public Online_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View contactView;
